function SLOptionLSMenuController() {
	...
	function UpdateData(data)
    {
		...
		var firstColumnDropdownElements = [ {name: 'signerLanguages', value: 'Languages'},{name: 'signerShowPositions', value: 'Position'},
											{name: 'signerIndicator', value: 'Indicator'},{name: 'signerAreas', value: 'Area'}]
