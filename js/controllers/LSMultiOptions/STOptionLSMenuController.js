function STOptionLSMenuController() {
	...
	function UpdateData(data)
    {
		...
		var firstColumnDropdownElements = [ {name: 'subtitlesLanguages', value: 'Languages'}, {name: 'subtitlesEasyRead', value: 'Easy to read'}, 
											{name: 'subtitlesShowPositions', value: 'Position'},{name: 'subtitlesBackground', value: 'Background'}, 
											{name: 'subtitlesSizes', value: 'Size'}, {name: 'subtitlesIndicator', value: 'Indicator'}, 
											{name: 'subtitlesAreas', value: 'Area'}]
