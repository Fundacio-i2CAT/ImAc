...
(function A(t, e) {
    ...
    return function(A) {
        ...
        i.prototype._buildAudioGraph = function() {
            ...
            this._inverter.gain.setValueAtTime(-1, this._context.currentTime); //i2cat
        ...
        function i(A) {
            ...
            this._inY.gain.setValueAtTime(-1, A.currentTime); //i2cat
            //this._inX.gain.value = -1;
            this._inX.gain.setValueAtTime(-1, A.currentTime); //i2cat
            ...
            this._outY.gain.setValueAtTime(-1, A.currentTime); //i2cat
            //this._outX.gain.value = -1;
            this._outX.gain.setValueAtTime(-1, A.currentTime); //i2cat
        ...
        i.prototype.setRotationMatrix4 = function(A) {
            ...
            this._m1.gain.value = (A[1] + 0) * 0;
            this._m2.gain.value = (A[2] + 0) * 0;
            this._m3.gain.value = (A[4] + 0) * 0;
            this._m4.gain.value = (A[5] + 0) * 0;
            this._m5.gain.value = (A[6] + 0) * 0;
            this._m6.gain.value = (A[8] + 0) * 0;
            this._m7.gain.value = (A[9] + 0) * 0;
            this._m8.gain.value = (A[10] + 0) * 0;*/
        };
        ...
        function n(A, t, e, i, n) {
            ...
            A[t - 1][r].gain.setValueAtTime(n, A[t - 1][r].context.currentTime); //i2cat
        ...
        w.prototype.setRotationMatrix3 = function(A) {
            for (let t = 0; t < 9; ++t) {
                this._gainNodeMatrix[0][t].gain.setValueAtTime(A[t], this._context.currentTime); //i2cat
        ...
        w.prototype.setRotationMatrix4 = function(A) {
            ...
            this._gainNodeMatrix[0][0].gain.setValueAtTime( -A[0] * 1, this._context.currentTime ); //i2cat
            this._gainNodeMatrix[0][1].gain.setValueAtTime( -A[1] * 1, this._context.currentTime ); //i2cat
            this._gainNodeMatrix[0][2].gain.setValueAtTime( -A[2] * 1, this._context.currentTime ); //i2cat
            this._gainNodeMatrix[0][3].gain.setValueAtTime( -A[4] * 1, this._context.currentTime ); //i2cat
            this._gainNodeMatrix[0][4].gain.setValueAtTime( -A[5] * 1, this._context.currentTime ); //i2cat
            this._gainNodeMatrix[0][5].gain.setValueAtTime( -A[6] * 1, this._context.currentTime ); //i2cat
            this._gainNodeMatrix[0][6].gain.setValueAtTime( A[8] * 1, this._context.currentTime ); //i2cat
            this._gainNodeMatrix[0][7].gain.setValueAtTime( A[9] * 1, this._context.currentTime ); //i2cat
            this._gainNodeMatrix[0][8].gain.setValueAtTime( A[10] * 1, this._context.currentTime ); //i2cat
