(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.milog = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
...
class logger {
    ...
    help()
    {
    	console.log( 'If you use MPEG-DASH player, please call sendDashMetrics( contentID, dash_player_object, view_lon, view_lat ) function.');
    	console.log( 'Else if you use HTML video, please call sendVideoMetrics( contentID, video_object, view_lon, view_lat ) function.');
    }

    sendDashMetrics( id, player, vlon=0, vlat=0 ) 
    {
    	var data = {
    		date: Date.now(),
			sessionId: this.id,
		...
		{
			// dash-if params
			data.mediaTime = player.time();
			data.url = player.getSource();
			data.quality = player.getQualityFor('video');
			data.averageThroughput = player.getAverageThroughput('video');
			data.currentBufferLevel = player.getBufferLength('video');
			// for 360 videos
			data.viewLon = vlon;
			data.viewLat = vlat;
		}

		postJSON( data, this.url );
    }

    sendVideoMetrics( id, vid, vlon=0, vlat=0 ) 
    {
    	var data = {
    		date: Date.now(),
			sessionId: this.id,
		...
		{
			// video params
			data.mediaTime = vid.currentTime;
			data.url = vid.src;
			// for 360 videos
			data.viewLon = vlon;
			data.viewLat = vlat;
